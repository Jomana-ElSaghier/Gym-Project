...
function validatePaymentForm() {
    ...
    if (!cardNumber || !expiryDate || !cvv || !cardHolder) {
        window.location.href = "/index.html?status=error&message=Something+wrong+happened";
    ...
    window.location.href = "/index.html?status=success&message=Payment+successful!";
    return true;
}
